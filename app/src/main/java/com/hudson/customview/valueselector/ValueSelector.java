...
public class ValueSelector extends View {
    ...
    public ValueSelector(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if(attrs!=null){
            TypedArray ta = context.obtainStyledAttributes(attrs,
                    R.styleable.ValueSelector);
            mLineLength = (int)ta.getDimension(R.styleable.ValueSelector_line_length,mLineLength);
            mRadius = (int)ta.getDimension(R.styleable.ValueSelector_circle_radius,mRadius);
            mLineStrokeWidth = (int) ta.getDimension(R.styleable.ValueSelector_line_stroke_width,mLineStrokeWidth);
            mMinValue = ta.getInteger(R.styleable.ValueSelector_min_value,DEFAULT_MIN_VALUE);
            mMaxValue = ta.getInteger(R.styleable.ValueSelector_max_value,DEFAULT_MAX_VALUE);
            mLineColor = ta.getColor(R.styleable.ValueSelector_line_color,DEFAULT_LINE_COLOR);
            mCircleColor = ta.getColor(R.styleable.ValueSelector_circle_color,DEFAULT_CIRCLE_COLOR);
            mTextSize = (int) ta.getDimension(R.styleable.ValueSelector_text_size,mTextSize);
            int style = ta.getInt(R.styleable.ValueSelector_style,0);
